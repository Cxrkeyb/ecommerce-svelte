<script lang="ts">
	...
	let pageTitle = 'Control Panel - Edit Product';
...
<div class="container mx-auto">
	<button
		...
		on:click={() => goto('/control-panel/products')}>Go back</button
	>
</div>
<div class="container mx-auto">
	...
	>
		<div class="mb-4">
			...
			<input
				type="text"
				id="name"
				class="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:border-indigo-500"
				bind:value={name}
				required
			/>
		</div>
		<div class="mb-4">
			...
			<textarea
				id="description"
				class="border border-gray-300 rounded-md px-3 py-2 w-full h-24 resize-none focus:outline-none focus:border-indigo-500"
